...
describe("Entry parsing", () => {
  test("one student parsing", () => {
    ...
    const student = parseEntry(studentLine, titleLine.split("\t"), studentTypeMap);
  ...
  test("one practice parsing", () => {
    ...
    const student = parseEntry(practiceLine, titleLine.split("\t"), practiceTypeMap);
  ...
  test("multiple student parsing", () => {
    ...
    const correctStudent1 = parseEntry(studentLine, titleLine.split(SPLITTER), studentTypeMap);
    const correctStudent2 = parseEntry(studentLine2, titleLine.split(SPLITTER), studentTypeMap);
